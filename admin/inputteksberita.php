...
<form action="index.php?menu=inputteksberita.php&aksi=kirim" method="post" enctype="multipart/form-data" name="frm1">
...
<?
if($aksi=="kirim"){
	$input=mysql_query("update informasi set info='$_POST[isi]' where id=4");
	if($input)  echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=inputteksberita.php\">");
	else echo "gagal";
}
